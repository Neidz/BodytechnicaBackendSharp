    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductsInMeals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductsInMeals_Meals_MealId",
                        column: x => x.MealId,
                        principalTable: "Meals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductsInMeals_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductsInMeals_MealId",
                table: "ProductsInMeals",
                column: "MealId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductsInMeals_ProductId",
                table: "ProductsInMeals",
                column: "ProductId");
        }
